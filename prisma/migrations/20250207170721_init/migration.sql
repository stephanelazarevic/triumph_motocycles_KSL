...
-- AddForeignKey
ALTER TABLE "Part" ADD CONSTRAINT "Part_idOrder_fkey" FOREIGN KEY ("idOrder") REFERENCES "Order"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Part" ADD CONSTRAINT "Part_idDealer_fkey" FOREIGN KEY ("idDealer") REFERENCES "Dealer"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
